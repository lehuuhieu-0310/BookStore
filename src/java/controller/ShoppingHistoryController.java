 ...
 * @author lehuuhieu
 */
@WebServlet(name = "ShoppingHistoryController", urlPatterns = {"/ShoppingHistoryController"})
public class ShoppingHistoryController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            List<OrderDTO> listOrder = orderDAO.findById(username);
            request.setAttribute("LIST", listOrder);
            url = "shoppingHistory.jsp";
        } catch (Exception e) {
