 ...
 * @author lehuuhieu
 */
@WebServlet(name = "FindCategoryController", urlPatterns = {"/FindCategoryController"})
public class FindCategoryController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            CategoryDTO dto = dao.findById(categoryId);
            request.setAttribute("DTO", dto);
            url = "updateCategory.jsp";
        } catch (Exception e) {
            log("ERROR at FindCategoryController: " + e.getMessage());
        } finally {
